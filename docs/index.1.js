...
window.PaginaDeInicio = Castelog.metodos.un_componente_vue2("PaginaDeInicio",
 ...
 + "        <div class=\"titulo_de_dia_de_semana\" style=\"text-align:center;\">"
 + "          <button v-on:click=\"() => cambiar_dia_de_semana('Lunes')\">Lunes</button>"
 + "          <span class=\"chivato_de_tareas\">{{ tareas_de_dia_lunes.length ? tareas_de_dia_lunes.length + \" tareas\" : \"\" }}</span>"
 + "        </div>"
 + "        <div class=\"cuadro_de_dia_3\">"
 + "          <input class=\"campo_de_texto_de_dia width_100\" type=\"text\" placeholder=\"Pon aquí tu nueva tarea y presiona ENTER\" v-model=\"tarea_de_dia_lunes\" v-on:keypress.enter=\"() => introducir_tarea('lunes')\" />"
 + "        </div>"
 ...
 + "        <div class=\"titulo_de_dia_de_semana\" style=\"text-align:center;\">"
 + "          <button v-on:click=\"() => cambiar_dia_de_semana('Martes')\">Martes</button>"
 + "          <span class=\"chivato_de_tareas\">{{ tareas_de_dia_martes.length ? tareas_de_dia_martes.length + \" tareas\" : \"\" }}</span>"
 + "        </div>"
 + "        <div class=\"cuadro_de_dia_3\">"
 + "          <input class=\"campo_de_texto_de_dia width_100\" type=\"text\" placeholder=\"Pon aquí tu nueva tarea y presiona ENTER\" v-model=\"tarea_de_dia_martes\" v-on:keypress.enter=\"() => introducir_tarea('martes')\" />"
 + "        </div>"
 + "        <div class=\"cuadro_de_dia_4\">"
 + "          <ul class=\"tareas_de_dia\">"
 ...
 + "        <div class=\"titulo_de_dia_de_semana\" style=\"text-align:center;\">"
 + "          <button v-on:click=\"() => cambiar_dia_de_semana('Miércoles')\">Miércoles</button>"
 + "          <span class=\"chivato_de_tareas\">{{ tareas_de_dia_miercoles.length ? tareas_de_dia_miercoles.length + \" tareas\" : \"\" }}</span>"
 + "        </div>"
 + "        <div class=\"cuadro_de_dia_3\">"
 + "          <input class=\"campo_de_texto_de_dia width_100\" type=\"text\" placeholder=\"Pon aquí tu nueva tarea y presiona ENTER\" v-model=\"tarea_de_dia_miercoles\" v-on:keypress.enter=\"() => introducir_tarea('miercoles')\" />"
 + "        </div>"
 + "        <div class=\"cuadro_de_dia_4\">"
 + "          <ul class=\"tareas_de_dia\">"
 ...
 + "        <div class=\"titulo_de_dia_de_semana\" style=\"text-align:center;\">"
 + "          <button v-on:click=\"() => cambiar_dia_de_semana('Jueves')\">Jueves</button>"
 + "          <span class=\"chivato_de_tareas\">{{ tareas_de_dia_jueves.length ? tareas_de_dia_jueves.length + \" tareas\" : \"\" }}</span>"
 + "        </div>"
 + "        <div class=\"cuadro_de_dia_3\">"
 + "          <input class=\"campo_de_texto_de_dia width_100\" type=\"text\" placeholder=\"Pon aquí tu nueva tarea y presiona ENTER\" v-model=\"tarea_de_dia_jueves\" v-on:keypress.enter=\"() => introducir_tarea('jueves')\" />"
 + "        </div>"
 + "        <div class=\"cuadro_de_dia_4\">"
 + "          <ul class=\"tareas_de_dia\">"
 ...
 + "        <div class=\"titulo_de_dia_de_semana\" style=\"text-align:center;\">"
 + "          <button v-on:click=\"() => cambiar_dia_de_semana('Viernes')\">Viernes</button>"
 + "          <span class=\"chivato_de_tareas\">{{ tareas_de_dia_viernes.length ? tareas_de_dia_viernes.length + \" tareas\" : \"\" }}</span>"
 + "        </div>"
 + "        <div class=\"cuadro_de_dia_3\">"
 + "          <input class=\"campo_de_texto_de_dia width_100\" type=\"text\" placeholder=\"Pon aquí tu nueva tarea y presiona ENTER\" v-model=\"tarea_de_dia_viernes\" v-on:keypress.enter=\"() => introducir_tarea('viernes')\" />"
 + "        </div>"
 + "        <div class=\"cuadro_de_dia_4\">"
 + "          <ul class=\"tareas_de_dia\">"
 ...
 + "        <div class=\"titulo_de_dia_de_semana\" style=\"text-align:center;\">"
 + "          <button v-on:click=\"() => cambiar_dia_de_semana('Sábado')\">Sábado</button>"
 + "          <span class=\"chivato_de_tareas\">{{ tareas_de_dia_sabado.length ? tareas_de_dia_sabado.length + \" tareas\" : \"\" }}</span>"
 + "        </div>"
 + "        <div class=\"cuadro_de_dia_3\">"
 + "          <input class=\"campo_de_texto_de_dia width_100\" type=\"text\" placeholder=\"Pon aquí tu nueva tarea y presiona ENTER\" v-model=\"tarea_de_dia_sabado\" v-on:keypress.enter=\"() => introducir_tarea('sabado')\" />"
 + "        </div>"
 + "        <div class=\"cuadro_de_dia_4\">"
 + "          <ul class=\"tareas_de_dia\">"
 ...
 + "        <div class=\"titulo_de_dia_de_semana\" style=\"text-align:center;\">"
 + "          <button v-on:click=\"() => cambiar_dia_de_semana('Domingo')\">Domingo</button>"
 + "          <span class=\"chivato_de_tareas\">{{ tareas_de_dia_domingo.length ? tareas_de_dia_domingo.length + \" tareas\" : \"\" }}</span>"
 + "        </div>"
 + "        <div class=\"cuadro_de_dia_3\">"
 + "          <input class=\"campo_de_texto_de_dia width_100\" type=\"text\" placeholder=\"Pon aquí tu nueva tarea y presiona ENTER\" v-model=\"tarea_de_dia_domingo\" v-on:keypress.enter=\"() => introducir_tarea('domingo')\" />"
 + "        </div>"
 + "        <div class=\"cuadro_de_dia_4\">"
 + "          <ul class=\"tareas_de_dia\">"
...
// (await RanasDB.dropDatabaseIfExists( "Modern_agenda_db" ));

Vue.prototype.$db = (await RanasDB.connect( "Modern_agenda_db",
[ [ { Task:"++id,name,moment"
},
function() {
} ] ],
